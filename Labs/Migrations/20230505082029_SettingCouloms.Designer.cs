...
namespace Labs.Migrations
{
    ...
    [Migration("20230505082029_SettingCouloms")]
    partial class SettingCouloms
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Labs.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Labs.Models.TbBusinessInfo", b =>
                {
            ...
            modelBuilder.Entity("Labs.Models.TbCashTransacion", b =>
                {
            ...
            modelBuilder.Entity("Labs.Models.TbCategory", b =>
                {
            ...
            modelBuilder.Entity("Labs.Models.TbCustomer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Labs.Models.TbItem", b =>
                {
            ...
            modelBuilder.Entity("Labs.Models.TbItemDiscount", b =>
                {
            ...
            modelBuilder.Entity("Labs.Models.TbItemImage", b =>
                {
            ...
            modelBuilder.Entity("Labs.Models.TbItemType", b =>
                {
                    b.Property<int>("ItemTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Labs.Models.TbO", b =>
                {
                    b.Property<int>("OsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Labs.Models.TbPurchaseInvoice", b =>
                {
            ...
            modelBuilder.Entity("Labs.Models.TbPurchaseInvoiceItem", b =>
                {
            ...
            modelBuilder.Entity("Labs.Models.TbSalesInvoice", b =>
                {
                    b.Property<int>("InvoiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Labs.Models.TbSalesInvoiceItem", b =>
                {
                    b.Property<int>("InvoiceItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Labs.Models.TbSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Labs.Models.TbSlider", b =>
                {
            ...
            modelBuilder.Entity("Labs.Models.TbSupplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Labs.Models.VwItem", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Labs.Models.VwItemCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Labs.Models.VwItemsOutOfInvoice", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(100)
            ...
            modelBuilder.Entity("Labs.Models.VwSalesInvoice", b =>
                {
                    b.Property<Guid>("CustomerId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Labs.Models.TbBusinessInfo", b =>
                {
                    b.HasOne("Labs.Models.TbCustomer", "Cutomer")
                        .WithOne("TbBusinessInfo")
                        .HasForeignKey("Labs.Models.TbBusinessInfo", "CutomerId")
            ...
            modelBuilder.Entity("Labs.Models.TbItem", b =>
                {
                    b.HasOne("Labs.Models.TbCategory", "Category")
                        .WithMany("TbItems")
                        .HasForeignKey("CategoryId")
                        .IsRequired()
                        .HasConstraintName("FK_TbItems_TbCategories");

                    b.HasOne("Labs.Models.TbItemType", "ItemType")
                        .WithMany("TbItems")
            ...
            modelBuilder.Entity("Labs.Models.TbItemDiscount", b =>
                {
                    b.HasOne("Labs.Models.TbItem", "Item")
            ...
            modelBuilder.Entity("Labs.Models.TbPurchaseInvoice", b =>
                {
                    b.HasOne("Labs.Models.TbSupplier", "Supplier")
            ...
            modelBuilder.Entity("Labs.Models.TbPurchaseInvoiceItem", b =>
                {
                    b.HasOne("Labs.Models.TbPurchaseInvoice", "Invoice")
            ...
            modelBuilder.Entity("Labs.Models.TbSalesInvoiceItem", b =>
                {
                    b.HasOne("Labs.Models.TbSalesInvoice", "Invoice")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Labs.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TbCustomerItem", b =>
                {
                    b.HasOne("Labs.Models.TbCustomer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Labs.Models.TbItem", null)
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
