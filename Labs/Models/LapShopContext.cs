...
using Microsoft.AspNetCore.Identity;                 // the security of the system
...
namespace Labs.Models
{
    public partial class LapShopContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public virtual DbSet<TbSettings> Settings { get; set; } = null!;
...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        {
            base.OnModelCreating(modelBuilder);       // Of Identity 
modelBuilder.UseCollation("Latin1_General_CI_AS");  // the methode that system read character
            ...
            modelBuilder.Entity<VwItemCategory>(entity =>    // sssssssssssssssssssssss
            {
                entity.HasNoKey();
